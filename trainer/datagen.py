...
class DirectoryIterator(Iterator):
    ...
    def __init__(self, directory, image_data_generator, triplet_path,
        ...
        self.images_list = {}
        super(DirectoryIterator, self).__init__(batch_size, shuffle, seed, triplet_path)
    ...
    def next(self):
        ...
        for i, j in enumerate(index_array):
            ...
            if not fname in self.images_list:
                img = load_img(os.path.join(self.directory, fname),
                               grayscale=grayscale,
                               target_size=self.target_size)
                self.images_list[fname] = img
            else:
                img = self.images_list[fname]
