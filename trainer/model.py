...
from tensorflow.keras.layers import Dropout, Flatten, Dense, Input, MaxPool2D, GlobalAveragePooling2D, Lambda, Conv2D, \
    concatenate, ZeroPadding2D, Layer, MaxPooling2D
...
def alexnet():
    ...
    alexnet_model = convnet('alexnet', weights_path="/home/ubuntu/deepranking_exp3/trainer/alexnet/alexnet_weights.h5",
                            heatmap=False)
