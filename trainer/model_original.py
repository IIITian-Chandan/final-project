...
def ranknet_resnet():
    ...
    convnet_output = GlobalAveragePooling2D()(resnet_model.output)
    convnet_output = Dense(4096, activation='relu')(convnet_output)
    convnet_output = Dropout(0.5)(convnet_output)
    convnet_output = Dense(4096, activation='relu')(convnet_output)
    convnet_output = Dropout(0.5)(convnet_output)
    ...
    final_model = tf.keras.models.Model(inputs=[s1_inp, s2_inp, resnet_model.input], outputs=l2_norm_final)

    return final_model

def ranknet_inception():
    inception_model = InceptionV3(weights="imagenet", include_top=False, input_shape=(224,224,3))
    convnet_output = GlobalAveragePooling2D()(inception_model.output)
    convnet_output = Dense(4096, activation='relu')(convnet_output)
    convnet_output = Dropout(0.5)(convnet_output)
    convnet_output = Dense(4096, activation='relu')(convnet_output)
    convnet_output = Dropout(0.5)(convnet_output)
    ...
    final_model = tf.keras.models.Model(inputs=[s1_inp, s2_inp, inception_model.input], outputs=l2_norm_final)
...
def alexnet():
    ...
    from alexnet.convnets import convnet

    alexnet_model = convnet('alexnet',weights_path="/home/ubuntu/deepranking_exp3/trainer/alexnet/alexnet_weights.h5", heatmap=False)
